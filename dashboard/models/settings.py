...
class DashboardSettingsLine(models.Model):
    ...
    color=fields.Selection([('red','Red'),('green','Green'),('primary','Primary'),('yellow','Yellow'),('orange','Orange'),
                            ('salmon', 'Salmon'),('scarlet', 'Scartlet'),('pink', 'Pink'),('violet', 'Violet'),
                            ('navy', 'Navy'),('olive', 'Olive'),('brown', 'Brown'),('gray', 'Gray'),
                            ('moss', 'Moss'),('wood', 'Wood')],string='Color')
